/* ==========================================================================
   jQuery Validation for Webflow
   https://www.npmjs.com/package/jquery-validation
   ========================================================================== */

$(document).ready(function () {
    $("#wf-form-Work-With-Aether").validate();
});

$(document).ready(function () {
    $("#wf-form-Build-With-Aether").validate();
});

$(document).ready(function () {
    $(' #wf-form-Build-With-Aether input[type=text]').each(function () {
        if ($(this).val()) {
...
$(document).ready(function () {
    $(' #wf-form-Work-With-Aether input[type=text]').each(function () {
        if ($(this).val()) {
            $(this).addClass("notEmpty");
        }
    });
...
$("#wf-form-Work-With-Aether").validate({
    ...
    /* ==========================================================================
       jQuery Autoresize Textarea
       https://www.npmjs.com/package/autoresize-textarea
       ========================================================================== */
